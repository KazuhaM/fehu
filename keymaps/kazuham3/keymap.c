...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-----------+-----------+-----------+-----------+-----------+-----------.    ,----------|-----------+-----------+-----------+-----------+-----------+-----------|
     ___    , COMM      , PGUP      , COLN      , PGDN      , ___	                                  , ___       , P1        , P2        , P3        , PDOT      , ___       ,
  //`-------+-----------+-----------+-----------+-----------+-----------+-----------/    \----------+-----------+-----------+-----------+-----------+-----------+-----------'
  ...
  //|-------+--------+--------+--------+--------+--------|                      |---------+---------+---------+---------+---------+--------|
     KC____ , KC_A   , KC_S   , KC_D   , KC_F   , KC_G                          , KC_H    , KC_J    , KC_K    , KC_L    , KC_SCLN , KC_BSPC,
  //|-------+--------+--------+--------+--------+--------|                      |--------+---------+---------+---------+---------+--------|
     KC____ , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B                          , KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC____ ,
  //`-------+--------+--------+--------+--------+--------+--------/    \--------+---------+---------+---------+---------+---------+--------'
     KC_SEN , CL_FN  , KC_LCTL, OS_CMW , KC_IEN , KC_CAPS              , KC_NLCK, KC_IJP  , OS_CMA  , KC_MRK  , KC_NUM  , KC_ENT
  //                                    `-------+--------+--------'    `--------+---------+--------'
  ),
